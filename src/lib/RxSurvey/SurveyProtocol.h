 ...
 * SpectrumProtocol.h owns 0x01/0x02. Multi-byte fields are big endian to match
...
enum
{
    ...
    SURVEY_FLAG_GATED_RADIO = 0x20,   // radio not running: WiFi/BLE or link-down sweep
...
// Channel centre in kHz, on the same axis as SpectrumBinFreqKhz().
