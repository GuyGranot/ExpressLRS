...
// Antenna-referred as SpectrumSweep::StoreBin does it, clamped clear of the sentinel.
...
{
    uint8_t gates = 0;
    // torn down for WiFi/BLE or a link-down sweep, or (CE) owned by LBT's CCA reads
