...
device_affinity_t ui_devices[] = {
  ...
  // Core 1 for the same reason: the bench-stream drain masks interrupts on its
  // own core only, and the tock ISR that fills the ring is attached from core 1.
  {&RxFlightSurvey_device, 1},
#endif
};
